...
// This version looks for the sequence matching a particular name
// knowing where it is placed within the file
void
read_fasta_file_from_offsets(const std::string &filename, 
